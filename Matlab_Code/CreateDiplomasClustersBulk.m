...
mainFolderPath = '/home/mondal/Documents/Project_Work/Diploma_Images_Text-Graphics-Seperation/DIBCO/Dataset/All_BackGd/';
finalResultDir = '/home/mondal/Documents/Project_Work/Diploma_Images_Text-Graphics-Seperation/DIBCO/Dataset/All_Cluster_Results/';
...
%         if (strcmp('H06_DIBCO_14.png',(subFolders(k).name)))
            ...
            imageNam1 = strcat(finalResultDir, name, '_Sure_and_Confused_Text_Imag', '.png');
            imageNam2 = strcat(finalResultDir, name, '_Sure_Text_Imag', '.png');
            textFileNam = strcat(finalResultDir, name, '_TextFile', '.txt');
            
            imwrite(mat2gray(fSure_and_ConfusedTextPixels),imageNam1);
            imwrite(mat2gray(fSureTextPixels),imageNam2);
